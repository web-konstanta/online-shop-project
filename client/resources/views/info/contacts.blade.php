                ...
                <div class="cs-sked cs-online-edit"><span class="cs-title cs-title_type_sidebar">Графік роботи</span><a
                    ...
                    <ul class="cs-sked__holder">
                        <li class="cs-sked__list">
                            <div class="cs-sked__item"><span class="cs-sked__day">Понеділок</span></div>
                            <div class="cs-sked__item"><span class="cs-sked__time">10:00</span><span
                                    class="cs-sked__time">18:00</span></div>
                        </li>
                        <li class="cs-sked__list">
                            <div class="cs-sked__item"><span class="cs-sked__day">Вівторок</span></div>
                            <div class="cs-sked__item"><span class="cs-sked__time">10:00</span><span
                                    class="cs-sked__time">18:00</span></div>
                        </li>
                        <li class="cs-sked__list">
                            <div class="cs-sked__item"><span class="cs-sked__day">Середа</span></div>
                            <div class="cs-sked__item"><span class="cs-sked__time">10:00</span><span
                                    class="cs-sked__time">18:00</span></div>
                        </li>
                        <li class="cs-sked__list">
                            <div class="cs-sked__item"><span class="cs-sked__day">Четвер</span></div>
                            <div class="cs-sked__item"><span class="cs-sked__time">10:00</span><span
                                    class="cs-sked__time">18:00</span></div>
                        </li>
                        <li class="cs-sked__list">
                            <div class="cs-sked__item"><span class="cs-sked__day">Пʼятниця</span></div>
                            <div class="cs-sked__item"><span class="cs-sked__time">10:00</span><span
                                    class="cs-sked__time">18:00</span></div>
                        </li>
                        <li class="cs-sked__list">
                            <div class="cs-sked__item"><span class="cs-sked__day">Субота</span></div>
                            <div class="cs-sked__item"><span class="cs-sked__time">10:00</span><span
                                    class="cs-sked__time">18:00</span></div>
                        </li>
                        <li class="cs-sked__list">
                            <div class="cs-sked__item"><span class="cs-sked__day">Неділя</span></div>
                            <div class="cs-sked__item"><span class="cs-sked__time">10:00</span><span
            ...
            <div class="cs-page__content">
                <div class="b-breadcrumb" data-bazooka="Breadcrumbs"
                    ...
                    <ul class="styles__breadcrumbs--21aTH">
                        ...
                        <li class="styles__item--3-4yf" title="Контакти"><span
                                ...
                                data-qaid="breadcrumbs_item">Контакти</span></li>
                    </ul>
                </div>
                <div class="cs-page__row">
                    <div
                        ...
                        <h1 class="cs-title-wrapper"><span class="cs-title">Контакти</span></h1>
