<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
  ...
  <ul class="menu-inner py-1 overflow-auto">
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">ОПЦИИ</span>
    </li>

    <li class="menu-item ">
      <a href="javascript:void(0);" class="menu-link">
        <i class="menu-icon tf-icons bx bx bx-dock-top"></i>
        <div>Управление личными данными</div>
      </a>

      <ul class="menu-sub d-block">
        ...
        <li class="menu-item ">
          <a href="{{ route('admin.account.reset-password') }}" class="menu-link">
